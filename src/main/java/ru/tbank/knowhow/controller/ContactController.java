...
import ru.tbank.knowhow.service.user.contact.UserContactService;
...
public class ContactController {
    ...
    @PostMapping("/tg")
    public ResponseEntity<?> addOrUpdateTgUsername(
    ...
    @GetMapping("/primary_notification_contact")
    ...
    @PatchMapping("/primary_notification_contact")

...
import ru.tbank.knowhow.core_service.security.GetCsrfTokenFilter;
import ru.tbank.knowhow.core_service.security.TokenCookieAuthenticationConfigurer;
import ru.tbank.knowhow.core_service.security.TokenCookieSessionAuthenticationStrategy;
import ru.tbank.knowhow.core_service.service.users.token.TokenCookieJweStringDeserializer;
import ru.tbank.knowhow.core_service.service.users.token.TokenCookieJweStringSerializer;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        String frontendBaseUrl = Objects.requireNonNull(env.getProperty("frontend.base.url"));
